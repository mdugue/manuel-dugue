		...
		<Sheet title="Impressum">
			<div className="prose lg:prose-lg prose-headings:font-display prose-headings:text-amber-500">
				...
				<p>
					...
					werden sowohl straf- als auch zivilrechtlich verfolgt. Dabei sind
					allein nach deutschem Zivilrecht Unterlassung und Schadenersatz,
					Überlassung oder Vernichtung der Vervielfältigungsvorrichtungen sowie
					die öffentliche Bekanntmachung des Urteils möglich.
					<br />
