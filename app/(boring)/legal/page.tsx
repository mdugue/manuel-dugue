	...
	return (
		<>
			...
			<p>
				...
				Pflichtangaben zur Anbieterkennzeichnung auf der Internet-Präsenz von
				Manuel Dugué.
			</p>
			...
			<p>
				Manuel Fridolin Dugué <br />
				Görlitzer Str. 23, 01099 Dresden
				<br />
				51.066050 13.754475
				<br />
				USt-IdNr: DE272030502
			</p>
			...
			<p>
				...
				unterliegen weltweitem Urheberrecht. Unerlaubte Verwendung, Reproduktion
				oder Weitergabe einzelner Inhalte oder kompletter Seiten werden sowohl
				straf- als auch zivilrechtlich verfolgt. Dabei sind allein nach
				deutschem Zivilrecht Unterlassung und Schadenersatz, Überlassung oder
				Vernichtung der Vervielfältigungsvorrichtungen sowie die öffentliche
				Bekanntmachung des Urteils möglich.
				<br />
			...
			<p>
				...
				Informationen zu Google Analytics und Datenschutz). Wir weisen Sie
