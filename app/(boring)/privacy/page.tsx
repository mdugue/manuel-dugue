	...
	return (
		<Sheet title="Datenschutzerklärung">
			<div className="prose lg:prose-lg prose-headings:font-display prose-headings:text-amber-500">
				<p>
					Datenschutz hat einen besonders hohen Stellenwert für Manuel Dugué.
					Eine Nutzung der Internetseiten vonManuel Dugué ist grundsätzlich ohne
				...
				<p>
					...
					und in Übereinstimmung mit den für die Manuel Dugué geltenden
				...
				<p>
					Durch den Einsatz von Cookies kann die Manuel Dugué den Nutzern dieser
				...
				<p>
					...
					anonym erhobenen Daten und Informationen werden durch die Manuel Dugué
				...
				<ul>
					...
					<li>
						...
						<p>
							...
							bei mir gespeichert sind, veranlassen möchte, kann sie sich hierzu
						...
						<p>
							...
							gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art.
							...
							die Verarbeitung nicht erforderlich ist. Der Mitarbeiter von
							Manuel Dugué wird im Einzelfall das Notwendige veranlassen.
						</p>
					</li>
					<li>
					...
					<li>
						...
						<p>
							Die Manuel Dugué verarbeitet die personenbezogenen Daten im Falle
						...
						<p>
							...
							Person gegenüber Manuel Dugué der Verarbeitung für Zwecke der
							Direktwerbung, so wird die Manuel Dugué die personenbezogenen
						...
						<p>
							...
							Verarbeitung personenbezogener Daten, die bei Manuel Dugué zu
				...
				<p>
					...
					über Google Analytics den Zusatz &quot;_gat._anonymizeIp&quot;.
