	...
	return (
		<>
			...
			<p>
				...
				Übereinstimmung mit den für die Manuel Dugué geltenden
			...
			<p>
				...
				erhobenen Daten und Informationen werden durch die Manuel Dugué daher
			...
			<ul>
				...
				<li>
					...
					<p>
						...
						Person die Löschung von personenbezogenen Daten, die bei mir
						...
						wenden. Der Mitarbeiter von Manuel Dugué wird veranlassen, dass dem
					...
					<p>
						...
						so trifft die Manuel Dugué unter Berücksichtigung der verfügbaren
						...
						Mitarbeiter von Manuel Dugué wird im Einzelfall das Notwendige
						veranlassen.
					</p>
				</li>
				<li>
					...
					<p>
						...
						bei Manuel Dugué gespeichert sind, verlangen möchte, kann sie sich
						hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
						Verantwortlichen wenden. Der Mitarbeiter von Manuel Dugué wird die
				...
				<li>
					...
					<p>
						...
						betroffene Person jederzeit an einen Mitarbeiter von Manuel Dugué
						wenden.
					</p>
				</li>
				<li>
					...
					<p>
						...
						steht. Widerspricht die betroffene Person gegenüber Manuel Dugué der
						Verarbeitung für Zwecke der Direktwerbung, so wird die Manuel Dugué
					...
					<p>
						...
						Person direkt jeden Mitarbeiter von Manuel Dugué oder einen anderen
				...
				<li>
					...
					<p>
						...
						der betroffenen Person, trifft die Manuel Dugué angemessene
