	...
	return (
		<SheetContent title={allInOnePageCollection?.items[0]?.title || ''}>
			<div
				...
				prose-h1:pt-4 prose-h1:text-lg prose-h1:font-inline prose-h1:text-gradient prose-h1:bg-linear-to-tr prose-h1:from-amber-500 prose-h1:to-amber-300 prose-h1:mb-2 prose-h1:self-start	prose-h1:col-span-4
				prose-h3:col-start-2 prose-h3:col-span-3 prose-p:col-start-2 prose-p:col-span-3 prose-ul:col-start-2 prose-ul:col-span-3
				md:prose-h2:text-right prose-h2:font-bold prose-h2:text-gradient prose-h2:bg-linear-to-tr prose-h2:from-teal-500 prose-h2:to-teal-600 md:prose-h2:justify-self-end prose-h2:capitalize prose-h2:text-base prose-h2:mb-2 prose-h2:mt-0 prose-h2:hyphens-auto 
				prose-h3:font-bold prose-h3:text-gray-700 prose-h3:text-gradient prose-h3:bg-linear-to-tr prose-h3:from-teal-700 prose-h3:to-teal-600 prose-h3:capitalize prose-h3:mb-0 prose-h3:text-base prose-h3:mt-0
				prose-p:mt-0 prose-p:mb-2 prose-p:text-gray-800
				prose-a:text-fuchsia-400 prose-a:font-medium prose-a:no-underline prose-a:hover:underline 
				`}
			>
