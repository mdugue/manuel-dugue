...
export default async function Quote() {
	...
	const response = await openai.createChatCompletion({
		...
		messages: [
			{
				role: 'system',
				content: `you are a creative engineer, who is passionate about product development and has a strong technical background. Your answers are short and entertaining. Your responses are formatted as plain text, using \n for new lines. Write a short summary about yourself in the first person perspective, based on the following skill profile: 
