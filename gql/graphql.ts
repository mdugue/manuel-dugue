...
export type AllInOnePageContentResources = {
	...
	block: Array<AllInOnePageContentResourcesBlock>;
	hyperlink: Array<AllInOnePageContentResourcesHyperlink>;
	inline: Array<AllInOnePageContentResourcesInline>;
};

export type AllInOnePageContentResourcesBlock = ResourceLink & {
	__typename?: "AllInOnePageContentResourcesBlock";
	sys: ResourceSys;
};

export type AllInOnePageContentResourcesHyperlink = ResourceLink & {
	__typename?: "AllInOnePageContentResourcesHyperlink";
	sys: ResourceSys;
};

export type AllInOnePageContentResourcesInline = ResourceLink & {
	__typename?: "AllInOnePageContentResourcesInline";
	sys: ResourceSys;
};
...
export type AllInOnePageQuery = {
	__typename?: "Query";
	allInOnePageCollection?: {
		__typename?: "AllInOnePageCollection";
		total: number;
		items: Array<{
			__typename: "AllInOnePage";
			...
			content?: { __typename?: "AllInOnePageContent"; json: any } | null;
		} | null>;
	} | null;
};
	...
	definitions: [
		{
			...
			operation: "query",
			name: { kind: "Name", value: "AllInOnePage" },
			variableDefinitions: [
				{
...
} as unknown as DocumentNode<AllInOnePageQuery, AllInOnePageQueryVariables>;
