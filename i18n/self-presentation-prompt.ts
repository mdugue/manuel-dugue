...
- Don't open the text with "I" or a first-person verb, and don't start both paragraphs or two sentences in a row that way. A text that starts with "I" sounds like a form being filled in. Lead with the matter instead: the project, the people it is for, the problem, or a place ("For engineers who develop commercial vehicles, …", "At Estino, …"). The text stays in the first person; the "I" just moves further into the sentence.
