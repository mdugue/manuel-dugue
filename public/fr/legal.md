...
Ce site contient des liens vers des sites externes de tiers sur le contenu
desquels je n'ai aucune influence. Je ne peux par conséquent pas assumer de
responsabilité pour ces contenus externes. Le fournisseur ou l'exploitant des
pages liées reste seul responsable de leur contenu.

## Droits d'auteur

Les contenus et œuvres créés par l'exploitant du site sur ces pages sont
soumis au droit d'auteur allemand. Les contributions de tiers sont
