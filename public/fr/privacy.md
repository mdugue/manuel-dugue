...
Ce site est hébergé par Vercel. Des fichiers journaux techniquement
nécessaires sont collectés (adresse IP, horodatage, user-agent, URL
demandée). Ces données sont traitées pour garantir la sécurité, la stabilité
et le respect des obligations légales (Art. 6, 1, f du RGPD).
...
Ce site utilise Umami Cloud (exploité par Umami Software, Inc., États-Unis)
pour une analyse d'audience respectueuse de la vie privée. Umami fonctionne
sans cookies, ne crée pas de profil de navigation entre les sessions et ne
collecte pas de données personnelles telles que le nom ou l'adresse
...
- d'effacement (Art. 17 RGPD)
- à la limitation du traitement (Art. 18 RGPD)
- à la portabilité (Art. 20 RGPD)
